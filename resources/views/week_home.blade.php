    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(i=0; i<data.length; i++){
                    html += '<tr id="'+data[i].id+'">'+
                                ...
                                '<td>' +data[i].week_pre_rank+'</td>'+
                                '<td>'+data[i].name+'</td>'+
                                '<td>'+data[i].team+'</td>'+
                                '<td>'+data[i].week_points+'</td>'+
                                '@if (Auth::user()->name == "aaa")'+
            ...
            $('#table_data').on('click','.editRecord',function(){
                ...
                console.log(id);
                var rank = $(this).data('week_rank');
                var pre_rank = $(this).data('week_pre_rank');
                var name = $(this).data('name');
                var team = $(this).data('team');
                var points = $(this).data('week_points');
