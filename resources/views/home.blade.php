...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading" style = "height:130px">
            ...
            <h1>
            <a href="{{ route('home') }}"><span class="pull-right btn btn-primary"  style = "font-size:15px;    margin-left: 10px;">Current Month </span> </a>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            $('#table_data').on('click','.editRecord',function(){
                ...
                var pre_rank = $(this).data('pre_rank');
